...
public class RegisterServlet extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rDispatcher = request.getRequestDispatcher("/pages/register.jsp");
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String forword_jsp = "/pages/register.jsp";
		...
		if(enter == true) {
			if(status==0) {
				...
				if(registerModel.registerCheck(name,image,category,price1,detail) == true) {
